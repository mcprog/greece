...
public class NBTHelper {
	...
	/**
	 * Creates a new compound if stack's tag is null
	 * @param itemStack: stack to init compound on
	 */
	...
	public static int getInteger (ItemStack itemStack, String keyName) {
		...
		if (!itemStack.stackTagCompound.hasKey(keyName)) {
			setInterger(itemStack, keyName, 0);
		}
	...
	public static double getDouble (ItemStack itemStack, String keyName) {
		...
		if (!itemStack.stackTagCompound.hasKey(keyName)) {
			setDouble(itemStack, keyName, 0D);
		}
	...
	public static void setInterger (ItemStack itemStack, String keyName, int keyValue) {
		initNBTTagCompound(itemStack);
