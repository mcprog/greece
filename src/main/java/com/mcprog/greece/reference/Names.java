...
public class Names {
	...
	public class Items {
		...
		public static final String MILD_BRONZE_INGOT = "mildBronzeIngot";
		...
		public static final String TINY_PILE_OF_SILVER_DUST = "tinyPileOfSilverDust";
		public static final String TINY_PILE_OF_GOLD_DUST = "tinyPileOfGoldDust";
		...
		public static final String TINY_PILE_OF_ELECTRUM_DUST = "tinyPileOfElectrumDust";
		...
		public static final String ELECTRUM_NUGGET = "electrumNugget";
	...
	public class Blocks {
		...
		public static final String ELECTRUM_BLOCK = "electrumBlock";
	...
	public class OreDictionary {
		...
		public static final String NUGGET_ELECTRUM = "nuggetElectrum";
